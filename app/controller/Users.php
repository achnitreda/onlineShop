        ...
        public function register(){
            ...
            if($_SERVER['REQUEST_METHOD']=='POST'){
                if($_POST['register']){
                 ...
                 // generate vkey
                $vkey = time(); //generate a random number that change every second
                $vkey = md5($vkey); //encrypt the number
                $vkey = str_shuffle($vkey);   //shuffle the string 
                ...
                //         $data['errName'] = 'Name Must Be Letters Only';
                // }
