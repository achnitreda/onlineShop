<?php 
    ...
    class User extends Controller{
        ...
        public function register($fullname, $email,$img, $hashedPassword,$vkey){
            ...
            $this->db->query(
                    "INSERT INTO users (full_name,email,image,password,verified,vkey,admin)
                    VALUES (:full_name,:email,:image,:password,0,:vkey,0)
                    ");
        ...
        public function findUserByEmail($email,$id=''){ // edit profile
