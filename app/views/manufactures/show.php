    ...
    <div class="   mt-4">
        ...
        <div class="card">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <strong><i class="fa fa-lock"></i> Status: </strong> <?php echo $data['manufacture']->active == 1 ? '<span class="badge bg-success">Active</span>':'<span class="badge bg-danger">InActive</span>'?>
                </li>
                <li>
