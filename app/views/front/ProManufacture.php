    ...
    <?php require_once ROOT ."/views/inc/slider.php" ?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
            ...
            if($data['products']){
                ...
                <p class="col-6 text-center text-danger"><span class='btn btn-sm btn-danger' style='border-radius:50%'><i class="fa fa-warning"></i></span> There is no any products under this brand</p>
            <?php  }
             ?>
        </div>
    </div>
