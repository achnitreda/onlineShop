                            ...
                            <tr>
                                ...
                                <td>
                                    <form class='d-inline' action="<?php echo URL ?>/carts/updateQty/<?php echo $cart->product ?> " method="POST">
                                        ...
                                        <input  class='text-white d-inline btn btn-info btn-sm py-0' name='upQty' type="submit" value='Up'>
                                    </form>
            ...
            <div class="card-body">
                <form id="payment-form" action="<?php echo URL ?>/carts/checkout" method="POST">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <?php echo  isset($data['errCity']) ?  'is-invalid' : '' ?>">
                    ...
                    <label for="cash" class="mr-4"><i class="fa-2x text-success fa-solid fa-money-bill-1"></i></label>
                    <input type="radio" class='d-none' name="payment_method" value='stripe' id='stripe'>
                    <label for="stripe" class='mr-4'><i class="fa-2x text-info fa-brands fa-cc-stripe"></i> </label>
