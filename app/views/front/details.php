                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 mt-2">
                        <ul class="list-unstyled">
                            <li class='my-2'>
                                <strong><i class="fa-brands fa-product-hunt"></i> Product: </strong> <?php echo $data['product']->name ?>
                            </li>
                            <li class='my-2'>
                                <strong><i class="fa-solid fa-money-bill-1"></i> Price: </strong><span class="badge bg-info"> <?php echo $data['product']->price ?>$</span>
                            </li>
                            ...
                            <li class='my-2'>
                                <strong><i class="fa-brands fa-black-tie"></i> Size: </strong> <?php echo $data['product']->size ?>
                            </li>
                            <li class='my-2'>
                            <li class='my-2'>
                        ...
                        <strong><i class="fa-solid fa-images"></i> Gallary</strong>
                        <?php 
                        ...
                        <?php 
                            ...
                            <span>
                                    <img class='img-fluid' style='width:80px;height:80px' src="<?php echo URL ?>/uploads/<?php echo $image->image_name ?>" alt="" />
                            </span>
                        <?php }
                        }else{?>
