                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 my-2">
                        <div class="card position-relative" >
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo URL ?>/carts/add/<?php echo $pro->product_id ?>/<?php echo $pro->price ?>" class="text-white btn btn-danger btn-sm py-1 float-end" style="font-size:13px"><i class="fa fa-shopping-cart"></i></a>
                            </div>
                        </div>
                    </div>
                <?php }
                }else {?>
                    <p class="col-6 text-center text-danger"><span class='btn btn-sm btn-danger' style='border-radius:50%'><i class="fa fa-warning"></i></span> There is no any products under this category</p>
                <?php  }
             ?>
        </div>
    </div>
