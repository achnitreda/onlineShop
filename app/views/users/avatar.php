                            ...
                            <form enctype="multipart/form-data" action="<?php echo URL?>/users/avatar/<?php echo Session::get('user_id') ?>" method="POST">
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" class="form-control" name='image' class="custom-file-input <?php echo  isset($data['errImg']) ?  'is-invalid' : '' ?>" id="inputGroupFile01">
                                    </div>
                                    <div class="input-group-prepend">
                                        <input class="btn btn-outline-secondary" name='addAvatar' type="submit" value='Upload image'>
                                    </div>
                                </div>
