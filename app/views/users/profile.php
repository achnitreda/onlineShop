                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><strong>Social: </strong> 
                                    <i style='color:#3b5998;padding:5px' class="fa-brands fa-facebook-square fa-2x"></i>
                                    <i style='color:#1da1f2;padding:5px' class="fa-brands fa-twitter-square fa-2x"></i>
                                    <i style='color:#ff0000;padding:5px' class="fa-brands fa-youtube-square fa-2x"></i>
                                </li>
                            </ul>
                        </div>
                    </div>
